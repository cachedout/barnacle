...
RUN apt-get update
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install wget gnupg2 vim python-dev python-pip python3-dev python3-pip libssl-dev
...
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install salt-master salt-minion salt-ssh salt-syndic salt-cloud salt-api
