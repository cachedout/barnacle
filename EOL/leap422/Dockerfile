...
RUN zypper --non-interactive  ar http://download.opensuse.org/repositories/systemsmanagement:/saltstack:/testing/openSUSE_Leap_42.2/systemsmanagement:saltstack:testing.repo
